<script>
  import manor from "/src/assets/manor.jpg"
...
<div class="uk-width-3-5@m  uk-card uk-card-default uk-padding-small uk-visible@m">
  <div class="uk-grid">
    <div class="uk-width-1-6@m">
      <a href="/"> <img src="{manor}" width="60" alt="img"/> </a>
    </div>
    ...
    <div class="uk-card uk-card-small uk-text-center uk-padding-remove">
      <a target="_blank" href="https://github.com/ThomasCullinane">
        <div>
          <i class="fas fa-chess-knight fa-3x" style="color:rgb(95, 96, 173)" title="Source repo" pos="bottom" uk-tooltip></i>
        </div>
        <div class="uk-width-expand@m uk-text-left">
